...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.layers import MultiheadAttention
...
def run_multihead_self_attention_with_rope(
    ...
    layer = MultiheadAttention(d_model, num_heads, theta, max_seq_len)
    layer.load_state_dict({
        "q_proj.weight": q_proj_weight,
        "k_proj.weight": k_proj_weight,
        "v_proj.weight": v_proj_weight,
...
def run_transformer_block(
    ...
    layer = TransformerBlock(d_model, num_heads, d_ff, max_seq_len=max_seq_len, theta=theta)
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.layers_utils import cross_entropy
